...
export default function CheckCard({task, cardId, checklistIndex, index}) {
    ...
    return (
        <CheckCardContainer>
            <Check {...label} size="small" sx={{ 
                padding: '1px',
                borderRadius: '3px'
                }} checked={task.checked} onClick={e =>handleOnChange(e)}/>
            <Title checked={task.checked}> <TextField fullWidth fontSize='16px' text={task.name} handleTextFieldOnBlur={handleUpdateName}/> </Title>
