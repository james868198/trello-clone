...
export default function Checklist({ checklist, index }) {
    ...
    const DeleteBtn = () => {
        return (
            <DeleteBtnContainer>
                <Button size="small" variant="contained" color="secondary" onClick={(e) => handleRemoveBtnOnClick(e)}>
                    Delete
                </Button>
            </DeleteBtnContainer>
        )
    ...
    const AddBtn = () => {
        return (
            <Button size="small" variant="contained" color="secondary" onClick={(e) => handleAddBtnOnClick(e)}>
                Add an item
            </Button>
        )
    }
